...
// Free packages - using the full versions
import { fas } from '@fortawesome/free-solid-svg-icons';
import { far } from '@fortawesome/free-regular-svg-icons';
import { fab } from '@fortawesome/free-brands-svg-icons';

// Alias the free packages to match your previous pro imports
const fal = far;  // Using free regular as light alternative
const fat = far;  // Using free regular as thin alternative
const fad = fas;  // Using free solid as duotone alternative
// Load icons into
